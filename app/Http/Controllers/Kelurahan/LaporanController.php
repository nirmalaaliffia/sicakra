...
class LaporanController extends Controller
{
    ...
    public function create($spj)
    {
        ...
        return view('kelurahan.laporan.daftarRealisasi', compact('form', 'opds', 'spjs'));
    }
    ...
    public function store(Request $request)
    {
        if($request->hasFile('file')){
            $file_pendukung=$request->file('file');
                ...
                return redirect()->route('kelurahan.laporanSpj.create', $request->rencana_kerja_id) ->with('success', 'Data Berhasil Diubah!');
    ...
    public function destroy(Request $request, $spj)
    {
        ...
        return redirect()->route('kelurahan.laporanSpj.create', $request->rencana_kerja_id)->with('danger', 'Data Berhasil Dihapus!');
    ...
    public function ajukan($id){
        ...
        if(count($spj) != "0"){
            ...
            return redirect()->route('kelurahan.laporanSpj')->with('success', 'Data Realisasi Berhasil Diajukan!');

        }else{
           return redirect()->route('kelurahan.laporanSpj.create', $id)->with('danger', 'Upload Realisasi Dahulu!');
    ...
    public function ajukanBatal($id){
        ...
        if(count($spj) != "0"){
            ...
            return redirect()->route('kelurahan.laporanSpj')->with('success', 'Data Pengajuan Realisasi Dibatalkan!');
