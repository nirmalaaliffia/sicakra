							...
							<div class="d-flex align-items-center mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
										...
										<li class="breadcrumb-item text-muted">
											<a href="" class="text-muted">Ditolak</a>
										</li>
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h2 class="card-label">Daftar Verifikasi Rencana Kerja Ditolak </h2>
										</div>
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif</td>
                                                        <td nowrap="nowrap">
                                                            <button type="button"  style="width:80%" class="btn btn-warning btn-sm passingTolak" data-id="{{ $form->id }}"><i class="flaticon-eye"></i> Detail</button>

                                                                <br><br>
															

																<button type="button" href="{{ route('kecamatan.verifikasi.rencanaKerja.ditarik', $form->id) }}" id="bukaKuncian" style="width:80%;height:10%" data-id="{{ $form->id }}" class="btn btn-info btn-sm">
