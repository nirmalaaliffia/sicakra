...
@section('main-content')
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										...
										<div class="card-toolbar">
                                            <a href="{{ route('kecamatan.laporanSpj') }}" class="btn btn-secondary font-weight-bolder">
											...
											<button data-toggle="modal" data-target="#modal-create-realisasi" class="btn btn-primary font-weight-bolder">
                                                ...
                                                <button type="button" href="{{ route('kecamatan.laporanSpj.ajukan', $form->id) }}" id="ajukanRelisasiBtn" class="btn btn-info font-weight-bolder ">
                                                ...
                                                <button type="button" href="{{ route('kecamatan.laporanSpj.ajukanBatal', $form->id) }}" id="batalkanRelisasiBtn" class="btn btn-warning font-weight-bolder">
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" href="{{ route('kecamatan.laporanSpj.destroy', $spj->id) }}" id="delete"  style="width:100%" data-id="{{ $form->id }}" class="btn btn-danger btn-sm">
                        ...
                        @include('kecamatan.laporan.form.show')
