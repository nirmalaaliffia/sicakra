								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h2 class="card-label">Daftar Realisasi Rencana Kerja Diajukan </h2>
										</div>
									...
									<div class="card-body">
                                        ...
                                        @endif
										<!--begin: Datatable-->
										<table class="table table-separate table-head-custom table-checkable kt_datatableRealisasiAjuan" >
											<thead>
												<tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($form->status_spj == 'Diajukan')
                                                            3
                                                        @elseif($form->status_spj  == 'Dibatalkan')
                                                            4
                                                        @elseif($form->status_spj  == 'BelumFinal')
                                                            5
                                                        @else
                                                            6
                                                        @endif</td>
                                                        <td nowrap="nowrap">
															...
															<a href="{{ route('kecamatan.verifikasi.laporanSpj.show', $form->id) }}"style="width:80%;height:10%" class="btn btn-warning btn-sm" data-id="{{ $form->id }}">
																<i class="flaticon2-notepad"></i> Verifikasi
															</a><br><br>
