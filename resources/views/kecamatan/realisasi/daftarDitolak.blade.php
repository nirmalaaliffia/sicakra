								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h2 class="card-label">Daftar Realisasi Rencana Kerja Ditolak</h2>
										</div>
									...
									<div class="card-body">
                                        ...
                                        @endif
										<!--begin: Datatable-->
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatableTolak">
											<thead>
												<tr>
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif</td>
                                                        <td nowrap="nowrap">
															<a href="{{ route('kecamatan.verifikasi.laporanSpj.readOnly', $form->id) }}"style="width:100%;height:10%" class="btn btn-danger btn-sm " data-id="{{ $form->id }}">
