                                ...
                                <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                    ...
                                    <div class="d-flex align-items-center mr-1">
                                        ...
                                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                                            <!--begin::Page Title-->
                                            <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Verifikasi Laporan Realisasi Rencana Kegiatan</h2>
                                            <!--end::Page Title-->
                                            <!--begin::Breadcrumb-->
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ asset($spj->link_bukti) }}" target="_blank"  style="width:100%"   class="btn btn-warning btn-sm">
