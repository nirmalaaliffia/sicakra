							...
							<div class="container">
								...
								<div class="card card-custom">
									...
									<div class="card-body">
                                        ...
                                        <form action="{{ route('kecamatan.rencana.update', $form->id) }}" id="form_edit_rencana" method="post"enctype="multipart/form-data">
                                            @csrf
                                            @method("PUT") 
                                         ...
                                         <a href="{{ route('kecamatan.rencana.daftar') }}" class="btn btn-secondary" >Kembali</a>
