								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h2 class="card-label">Daftar Rencana Kerja Disetujui - {{ auth()->user()->name }}</h2>
										</div>
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif</td>
                                                        <td nowrap="nowrap">
                                                            <button type="button"  style="width:80%" class="btn btn-warning btn-sm passingSetuju" data-id="{{ $form->id }}"><i class="flaticon-eye"></i> Detail</button>
