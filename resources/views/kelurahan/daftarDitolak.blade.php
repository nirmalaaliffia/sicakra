								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h2 class="card-label">Daftar Rencana Kerja Ditolak - {{ auth()->user()->name }}</h2>
										</div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td nowrap="nowrap">
                                                            <button type="button"  style="width:80%" class="btn btn-warning btn-sm passingTolak" data-id="{{ $form->id }}"><i class="flaticon-eye"></i> Detail</button>
																...
																<a href="{{ route('kelurahan.rencanaKerja.edit', $form->id) }}" style="width:80%" class="btn btn-success btn-sm">
