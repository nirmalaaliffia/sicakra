                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td nowrap="nowrap">
                                                                ...
                                                                <a href="{{ route('kelurahan.laporanSpj.create', $form->id) }}" style="width:100%" class="btn btn-info btn-sm">
                                                                ...
                                                                <a href="{{ route('kelurahan.laporanSpj.create', $form->id) }}" style="width:100%" class="btn btn-success btn-sm" data-id="{{ $form->id }}"><i class="flaticon-eye"></i> Lihat Realisasi</a>
