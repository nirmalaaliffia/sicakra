                                                    ...
                                                    <td>
                                                        ...
                                                        <td nowrap="nowrap">
                                                            <button type="button"  style="width:100%" class="btn btn-warning btn-sm passingID" data-id="{{ $form->id }}"><i class="flaticon-eye"></i> Detail</button>
                                                                ...
                                                                <a href="{{ route('kelurahan.rencanaKerja.edit', $form->id) }}" style="width:100%" class="btn btn-success btn-sm">
                                                                ...
                                                                <button type="button" href="{{ route('kelurahan.rencanaKerja.destroy', $form->id) }}" id="delete"  style="width:100%" data-id="{{ $form->id }}" class="btn btn-danger btn-sm">
