        ...
        <div class="container d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <a href="{{ route('admin.page') }}">
                    <img alt="Logo" src="{{ asset('asset_admin/assets/media/logos/logo-letter-1.png') }}" class="logo-sticky max-h-35px" />
                </a>
                @endrole
                @role(config('permission.available_roles.user'))
            ...
            <div class="topbar">
                ...
                <div class="dropdown">
                    ...
                    <div class="topbar-item mr-4" data-toggle="dropdown" data-offset="10px,0px">
                            ...
                            <a  class="btn font-weight-bolder btn-sm btn-light-danger px-5" href="{{ route('logout') }}" 
